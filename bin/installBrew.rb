...
Dir.chdir HOMEBREW_PREFIX do
  if git
    ...
    system git, "init", "-q"
    system git, "remote", "add", "origin", "https://github.com/sruon/homebrew"
    ...
    system "/bin/bash -o pipefail -c '/usr/bin/curl -#{curl_flags} https://github.com/sruon/homebrew/tarball/master | /usr/bin/tar xz -m --strip 1'"
  end
end
